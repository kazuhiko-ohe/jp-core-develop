...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile JP_Practitioner
  ...
  <sch:pattern>
    <sch:title>Practitioner.text.extension</sch:title>
  ...
  <sch:pattern>
    <sch:title>Practitioner.text.status</sch:title>
    <sch:rule context="f:Practitioner/f:text/f:status">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Practitioner.text.div</sch:title>
