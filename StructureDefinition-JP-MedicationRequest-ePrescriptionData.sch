...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>MedicationRequest.dosageInstruction.extension.value[x] 1</sch:title>
    <sch:rule context="f:MedicationRequest/f:dosageInstruction/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern>
    <sch:title>MedicationRequest.dosageInstruction.extension.value[x].start 1</sch:title>
    <sch:rule context="f:MedicationRequest/f:dosageInstruction/f:extension/f:value[x]/f:start">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationRequest.dosageInstruction.extension.value[x].end 1</sch:title>
    <sch:rule context="f:MedicationRequest/f:dosageInstruction/f:extension/f:value[x]/f:end">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
